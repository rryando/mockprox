export const CLIMessages = {
  ...
  DATA_INVALID:
    'This file is not a valid OpenAPI specification (JSON or YAML v2.0.0 and v3.0.0) or Mockprox environment',
  DATA_TOO_OLD_ERROR:
    "These environment's data are too old or not a valid Mockprox environment.\nPlease verify or migrate them using a more recent version of the application",
  DATA_TOO_RECENT_ERROR:
    "These environment's data are too recent and cannot be run with the CLI\nPlease update the CLI with the following command 'npm install -g @mockprox/cli'",
